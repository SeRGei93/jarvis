...
5. **Verify before citing.** URLs from web_search are unverified candidates. Call fetch_url on each before citing. If it fails (404, timeout, error, paywall, login wall, wrong content) — discard silently.
