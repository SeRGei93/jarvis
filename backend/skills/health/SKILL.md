...
Drug variants → Markdown table (link to «Где купить» after the table per variant):
```
**Ибупрофен — варианты в аптеках:**

| Препарат      | Форма    | Дозировка | Кол-во | Цена, BYN |
|:--------------|:---------|:----------|:-------|----------:|
| Нурофен       | таблетки | 200 мг    | 12 шт  | 8.50      |
| Ибупрофен     | таблетки | 200 мг    | 50 шт  | 2.29–2.69 |
| Ибупрофен макс| таблетки | 400 мг    | 10 шт  | 3.30–6.88 |
| Ибупрофен д   | суспензия| 100 мг/5мл| 100 мл | 8.00–12.83|

Где купить: [Нурофен](url-from-tool) · [Ибупрофен](url-from-tool) · [Ибупрофен макс](url-from-tool) · [Ибупрофен д](url-from-tool)
```
